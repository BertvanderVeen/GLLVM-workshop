---
title: "Practical: Tools, tips and tricks"
...
The models generally fitted with the <tt>gllvm</tt> R-package are complex, and sometimes require carefully tuning the arguments in the model to get an improved solution. In this practical, we will go through some of the arguments that control model fitting, including repeated fits with different starting values.
