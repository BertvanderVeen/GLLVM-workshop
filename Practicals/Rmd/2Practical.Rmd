...
model5 <- gllvm(Y, studyDesign=X, row.eff = ~(1|island), family = "negative.binomial", num.lv = 0)
```

The "model5" treats island as a species-common random intercept instead of the species-specific version in "model4", and drops the silt_clay/elevation random slopes entirely. We can go ahead and compare them with AIC:
