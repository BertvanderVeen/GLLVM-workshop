...
As a reminder from Practical 1: we fit with `sd.errors = FALSE` by default and only calculate standard errors afterwards with `se.gllvm`, once we need them for a `summary`, `coefplot`, `randomCoefplot`, or `confint`.
