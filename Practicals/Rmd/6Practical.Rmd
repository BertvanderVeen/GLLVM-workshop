...
ter Braak (1986) notes that the canonical coefficients in constrained ordination methods tend to be affected by issues of multicollinearity, and can bounce around a lot. Here, we can improve that by treating them as random effects; this penalizes them a ltitle. 
