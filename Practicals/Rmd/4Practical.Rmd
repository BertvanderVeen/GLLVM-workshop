...
\begin{equation}
\symbf{\beta}_j = \symbf{\beta}_k + \text{tr}_j\textbf{B}_{x,tr}
\end{equation}

This means that there is still a common component to species' environmental responses, $\symbf{\beta}_k$, but that the deviation from that for every species is fully determined by the traits $\text{tr}_j\textbf{B}_{x,tr}$. 
