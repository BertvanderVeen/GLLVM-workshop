...
In terms of tasks, you can go through similar steps as you did in the first part of the exercise: expplore the data, fit some models, do some model selection, and see if you can draw ecological conclusions using the information at your disposal (parameter estimates and statistical uncertainty).