...
- Conditioning
- Constrained, concurrent, and unconstrained ordination
...
In classical ordination, eigenvalues tell us the variation explained by each dimension. Latent variable models are not that straightforward.

- We do not estimate all axes simultaneously
- There is no variation explained on the response scale
- We can do model selection (similar to "stress" in NMDS)
...
The trace of the residual covariance matrix gives total variation explained by the latent variables. Dividing by dimension gives the relative contribution of each axis.

## Importance of dimensions

- Importance does not equal variation explained
- The first dimension may or may not be most ecologically relevant
- Dimensions with less variation may still capture important gradients
- Measure "importance" via model fit: `AIC`, `BIC`, or `goodnessOfFit`
...
\textcolor{red}{You adjust the model to accommodate whatever property of the data}
