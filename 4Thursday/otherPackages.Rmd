...
\texttt{glmmTMB} is especially useful if you want user friendliness and many other random effects. Ordination is an afterthought in a package does many other things (but also still new).
...
\tiny glmmTMB & yes & yes & no & no & yes & yes & yes & soon & Kind of & F \\
