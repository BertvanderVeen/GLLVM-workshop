...
\footnotesize Average intercept: `r round(model4$params$beta0, 3)`, `r round(mean(ints2), 3)`. Average slope: `r round(model4$params$row.params.fixed[1], 3)`, `r round(mean(slps2), 3)`. \normalsize
