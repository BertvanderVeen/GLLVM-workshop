...
Now there is a principled alternative.
...
\small [Warton et al. (2012)](https://besjournals.onlinelibrary.wiley.com/doi/full/10.1111/j.2041-210X.2011.00127.x): equal dispersion parameter, different means. Bray-Curtis ordination still suggests a dispersion effect. \normalsize
...
\footnotesize Low-abundance group appears more dispersed in NMDS, but the dispersion parameter is identical; variance just tracks the mean. \textcolor{red}{This is a Bray-Curtis artefact, not a real dispersion effect.} \normalsize
...
\begin{table}
\footnotesize
\begin{tabular}{p{2.4cm}p{3.3cm}p{3.6cm}}
\toprule
